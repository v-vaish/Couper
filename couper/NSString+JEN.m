...
-(BOOL)isValid
{
    return ([self isEqual:[NSNull null]] || [[self removeWhiteSpacesFromString] isEqualToString:@""] || self == nil || [self isEqualToString:@"(null)"]) ? NO :YES;
}
...
{
    return ([self isValid] && self.length > 3);
}
